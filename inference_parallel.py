...
snake_manager.brain.load_state_dict(torch.load('models/snake_a2c_Feat_dim7_epoch690_20250215-134600.pth', map_location=device))

for epoch in range(10):
    snake_manager.reset_envs(display_example=True)
    average_score, average_game_length, win_percent, max_score, runtime = snake_manager.inference_envs(plot_activation=True)
